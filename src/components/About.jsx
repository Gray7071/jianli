          ...
          <div className="about-highlights">
            <div className="highlight-item">
              ...
              <span className="highlight-label">
                {isZh ? '年嵌入式开发经验' : 'Years Embedded Dev'}
              </span>
            </div>
            <div className="highlight-item">
              <span className="highlight-number">10+</span>
              <span className="highlight-label">
                {isZh ? '个开源项目' : 'Open Source Projects'}
              </span>
            </div>
            <div className="highlight-item">
              <span className="highlight-number">ARM / RISC-V</span>
              <span className="highlight-label">
                {isZh ? '常用平台架构' : 'Platform Architectures'}
              </span>
            </div>
          </div>
        </div>
